...
public class SQLiteHelper extends SQLiteOpenHelper
{
    ...
    final String FULL_SCHEMA="CREATE TABLE IF NOT EXISTS tema(idTema TEXT PRIMARY KEY, tituloTema TEXT NOT NULL, complejidad INTEGER NOT NULL); " +
                            ...
                            "CREATE TABLE IF NOT EXISTS instruccion_pr(idInstruccionPr TEXT PRIMARY KEY, idInstruccion TEXT NOT NULL, idPuzzleRecepcion TEXT NOT NULL, identacion INTEGER NOT NULL, instruccionPuzzle TEXT NOT NULL, FOREIGN KEY (idInstruccion) REFERENCES instruccion(idInstruccion) ON DELETE CASCADE ON UPDATE CASCADE, FOREIGN KEY (idPuzzleRecepcion) REFERENCES puzzleRecepcion(idPuzzleRecepcion) ON DELETE CASCADE ON UPDATE CASCADE); " +
